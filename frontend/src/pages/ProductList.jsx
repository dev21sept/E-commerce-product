            ...
            <div className="card overflow-hidden">
                <div className="p-4 md:p-6 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white">
                    <div className="flex flex-col md:flex-row md:items-center gap-4 flex-1">
                        ...
                        {/* Sub-Filters (AI/eBay) - Only show for Admin when statusFilter is 'all' */}
                        {statusFilter === 'all' && (!user || user.role === 'admin') && (
                        ...
                        <div className="p-4 md:p-6 bg-gray-50/50 border-t border-gray-100 space-y-4">
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    {(!previewProduct.target_platform || previewProduct.target_platform === 'ebay') && (!user || user.role === 'admin' || user.allowExtensionListing) && (
                                        <button
                                            onClick={() => {
                                    ...
                                    {(!previewProduct.target_platform || previewProduct.target_platform === 'ebay') && (!user || user.role === 'admin' || user.allowApiListing) && (
                                        <button
                                            onClick={async () => {
                                                try {
