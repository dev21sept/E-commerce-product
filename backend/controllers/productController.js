...
exports.getAllProducts = async (req, res) => {
    ...
    try {
        ...
        const products = await Product.find(query)
            .select('title sku selling_price images category created_at updated_at source ai_generated brand condition_name condition_notes gender item_specifics variations description status agentId')
            .sort({ updated_at: -1 })
            .maxTimeMS(10000)
            .lean();
